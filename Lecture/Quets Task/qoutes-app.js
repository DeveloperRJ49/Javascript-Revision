...
let getQuete = (queteNum) => {
     queteNum = Math.floor(Math.random() * 10);

    console.log(qoutes [queteNum]);

    document.getElementById("quote").innerHTML = `"${qoutes[queteNum].quote}"`
    document.getElementById("author").innerHTML = `"${qoutes[queteNum].author}"`
    document.getElementById("profession").innerHTML = `"${qoutes[queteNum].quote}"`
